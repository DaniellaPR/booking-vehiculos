...
namespace Microservicios.Coche.DataAccess.Queries
{
    public class RolQueryRepository
    {
        ...
        public RolQueryRepository(CocheDbContext context)
        {
            _context = context;
        }

        public async Task<PagedResult<RolEntity>> BuscarAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default)
        {
